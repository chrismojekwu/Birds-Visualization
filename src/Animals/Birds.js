...
const Birds = {
  ...
  Pigeon: {
    ...
    image: "darkgray",
    svg: pigeon,
    info: `Pigeons or doves are the bird family Columbidae. The common names pigeon and dove are often used interchangeably. In ornithology, "dove" tends to be used for smaller species and "pigeon" for larger ones.`,
    connection: {
  ...
  Goose: {
    ...
    image: "honeydew",
    svg: goose,
    info: `A goose (plural geese) is a bird of any of several waterfowl species in the family Anatidae. A male goose is called a "gander" and a baby goose is called a "gosling". A group of geese is called a "gaggle".`,
    connection: {
  ...
  Hummingbird: {
    ...
    connection: {
      Swift: {
        detail: `They both belong to the family Apodiformes meaning "unfooted birds."`,
      },
    },
  },
  Swift: {
  ...
  Toucan: {
    ...
    connection: {
      Passerine: {
        detail:
          "Toucans belong to the neotropical near passerine bird family Ramphastidae.",
      },
    },
  },
  Passerine: {
    ...
    image: "brown",
    svg: passerine,
    info: `A passerine is any bird of the order Passeriformes, which includes more than half of all bird species. Sometimes known as perching birds or songbirds, passerines are distinguished from other orders of birds by the arrangement of their toes (three pointing forward and one back), which facilitates perching.`,
    connection: {
      Toucan: {
        detail:
          "Toucans belong to the neotropical near passerine bird family Ramphastidae.",
  ...
  Cities: {
    ...
    connection: {
      ...
      Passerine: {
        detail: "Many species of Passerine birds live in or near cities.",
      },
      Parrot: {
        detail:
          "Due to human interaction its known that parrots can survive in cities.",
      },
    },
  },
  Woodlands: {
    ...
    connection: {
      ...
      Passerine: {
        detail: "Many species of passerine birds can live in the woodlands.",
      },
  ...
  Water: {
    ...
    connection: {
      Vulture: {
        detail:
          "Though they prefer deserts, vultures will inhabit grasslands near a water source.",
      },
      Penguin: {
        detail: "Penguins live up to 80% of their live sin the ocean.",
      },
      ...
      Pelican: {
        detail:
          "Pelican prefer to livee and hunt in inland and coastal bodies of water.",
      },
      Heron: {
        detail:
          "Herons are essentially nonswimming waterbirds that feed on the margins of lakes, rivers, swamps, ponds, and the sea.",
      },
      Hawk: {
        detail:
          "Hawks can thrive living near bodies of water and hunting fish.",
      },
    },
  },
};
